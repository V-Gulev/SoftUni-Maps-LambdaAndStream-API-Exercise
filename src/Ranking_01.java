...
public class Ranking_01 {
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Map<String, Integer>> userEntry : people.entrySet()) {
            ...
            userEntry.getValue().entrySet().stream().sorted((a, b) -> b.getValue().compareTo(a.getValue())).forEach(contestEntry -> System.out.printf("#  %s -> %d%n", contestEntry.getKey(), contestEntry.getValue()));
        }
    }
}
